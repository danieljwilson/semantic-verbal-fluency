...
const PAGES = {
    ...
    <form>
        ...
        <button disabled type="button" class="form-control btn btn-primary mt-3" onclick="saveResultAndNext('jobs', 'verbalInstructionsPage');">next</button>
    </form>
    `,
    ...
    Please list as many words as possible that start with the letter
        ...
        <button disabled type="button" class="form-control btn btn-primary mt-3" onclick="saveResultAndNext('F', 'endingPage');">next</button>
    </form>
    `,
